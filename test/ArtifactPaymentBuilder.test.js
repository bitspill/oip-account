...
test("APB, getPaymentAddresses()", async () => {
...
test("APB, getWalletBalances(): without coin parameters", async () => {
    expect.assertions(3);
...
test("APB, getWalletBalances(): with one coin parameter (flo)", async () => {
